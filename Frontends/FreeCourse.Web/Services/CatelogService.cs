...
{
    // user ile uyelik istenmeyen servis sadece token ile erişilebilir
    public class CatelogService : ICatelogService
    {
        ...
        public CatelogService(HttpClient client, IPhotoStockService photoStockService, PhotoHelper photoHelper)
        {
            _client = client;

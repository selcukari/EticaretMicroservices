...
{
    // fakepayment ve order service ile token exchange yaparken kullanılacak
    public class TokenExchangeExtensionGrantValidator: IExtensionGrantValidator
    {
        ...
        // token dogrulama islemi gateway tarafinda yapilir
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            var deneme = tokenValidateResult.Claims;
